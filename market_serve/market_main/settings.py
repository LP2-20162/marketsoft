"""
Django settings for market_main project.
...
SECRET_KEY = '))@-yo6)g=l@fv=+cz5*(^*n1=vd35+47mp)e17$4s$sx4*0+x'
...
WSGI_APPLICATION = 'market_main.wsgi.application'
